...
with gr.Blocks(theme=gr.themes.Glass()) as iface:
    ...
    with gr.Tabs():
        with gr.TabItem("Overview"):
             gr.Markdown("### Protein Overview\nKey information: UniProt ID, name, gene, organism, function, sequence snippet & UniProt link.")
        ...
        with gr.TabItem("Functional Context"):
             ...
             with gr.Accordion("Biological Pathways (KEGG, Reactome)", open=False): pathways_output = gr.Markdown()
        ...
        with gr.TabItem("Cross-references"):
             gr.Markdown("### Database Links\nLinks to other relevant biological databases.")
